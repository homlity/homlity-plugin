...
// Cover image
$coverImg = get_the_post_thumbnail_url($post_id, 'medium') ?: '';

// WhatsApp link
$whatsAppLink = '';
if ($agentDigits && in_array('whatsapp', $listingFields, true)) {
...
<div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-3">
    <article class="card h-100 shadow-sm border-0 property-card-bs"
        ...
        <div class="card-body d-flex flex-column gap-2 p-3">
            ...
            <?php if ($displayPrice && in_array('price', $listingFields, true)) : ?>
            ...
            <?php if ($typeLabel || $operationLabel) : ?>
            ...
            <p class="card-text small text-muted mb-0" itemprop="description">
                <?php echo esc_html(wp_trim_words(get_the_excerpt($post_id), 18)); ?>
            </p>
            <?php endif; ?>

            <?php if (in_array('features', $listingFields, true) && ($area || $bedrooms || $bathrooms || $parking)) : ?>
            <ul class="list-inline mb-0 small d-flex flex-wrap gap-2">
                <?php if ($area) : ?>
            ...
            <a href="<?php echo esc_url($whatsAppLink); ?>"
               ...
               target="_blank" rel="noopener noreferrer">
                ...
                <?php esc_html_e('Más información', 'homlity-plugin'); ?>
            </a>
            <?php endif; ?>
