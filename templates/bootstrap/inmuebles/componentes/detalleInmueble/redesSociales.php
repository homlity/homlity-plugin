...
<ul class="socio-links">
    ...
    'label': 'facebook_open',
    'value': '<?php echo esc_js( $nombre ); ?>'
  });" target="_blank"
        href="<?php echo esc_url( visualinmu_redsocial_url( [ 'nombre' => 'facebook', 'texto' => $texto ], $route ) ); ?>"
    ...
    'value': '<?php echo esc_js( $nombre ); ?>'
        ...
        href="<?php echo esc_url( visualinmu_redsocial_url( [ 'nombre' => 'x', 'texto' => $texto ], $route ) ); ?>"
    ...
    'value': '<?php echo esc_js( $nombre ); ?>'
        ...
        href="<?php echo esc_url( visualinmu_redsocial_url( [ 'nombre' => 'whatsapp', 'texto' => $texto ], $route ) ); ?>"
    ...
    'value': '<?php echo esc_js( $nombre ); ?>'
        ...
        href="<?php echo esc_url( visualinmu_redsocial_url( [ 'nombre' => 'linkedin', 'texto' => $texto ], $route ) ); ?>"
    ...
    'value': '<?php echo esc_js( $nombre ); ?>'
        ...
        href="<?php echo esc_url( visualinmu_redsocial_url( [ 'nombre' => 'email', 'texto' => $texto . ' descripción: ' . $descripcion, 'asunto' => $nombre ], $route ) ); ?>"
