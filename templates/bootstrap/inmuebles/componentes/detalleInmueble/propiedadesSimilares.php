<div class="row">
    <div class="col-md-12">
        <h3 class="visualinmueble-titulos-propiedades-similares h4">Inmuebles similares</h3>
    </div>
    <?php
    /**
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <a href="<?php echo visualinmu_route_detalleInmueble($inmueble->slug()); ?>"
                               target="_blank">
                                <h5
                                        class="card-title"><?php echo $inmueble->codigo(); ?><?php echo $inmueble->nombre(); ?></h5>
                            </a>
                            <hr>
                            <p>
                                <a href="<?php echo visualinmu_route_detalleInmueble($inmueble->slug()); ?>"
                                   target="_blank">
                                    <i class="icon-homlity icon-uniE91C"></i> <?php echo $inmueble->ciudad()->nombre(); ?>
                                    - <?php echo $inmueble->departamento()->nombre(); ?></a></p>
                            <?php if ($inmueble->gestion()->esArriendoVenta()) : ?>
                                <p class="precios"><strong>V. venta</strong>
                                    $<?php echo $inmueble->valorVenta(true); ?></p>
                                <p class="precios"><strong>V. arriendo</strong>
                                    $<?php echo $inmueble->valorCanon(true); ?></p>
                            <?php elseif ($inmueble->gestion()->esAriendo()) : ?>
                                <p class="precios"><strong>V. arriendo</strong>
                                    $<?php echo $inmueble->valorCanon(true); ?></p>
                            <?php else : ?>
                            ...
                            <div class="row d-flex justify-content-center text-center">
                                <div class="col">
                                    <p>
                                        <i class="icon-homlity icon-uniE938"></i> <?php echo $inmueble->nAlcobas(); ?>
                                    </p>
                                </div>
                                <div class="col">
                                    <p>
