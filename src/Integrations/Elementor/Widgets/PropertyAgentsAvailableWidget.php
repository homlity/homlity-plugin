...
class PropertyAgentsAvailableWidget extends Widget_Base
{
    ...
    /**
     * La hoja que da forma a las tarjetas de asesor.
     *
     * Sin esto el widget salía sin estilos en la web pública y con ellos en el
     * editor, que es lo que lo hacía tan desconcertante: enqueuePreviewAssets()
     * mete las dos hojas dentro del iframe de Elementor, así que la tarjeta se
     * maquetaba mientras se editaba y se deshacía al publicar. Elementor solo
     * carga lo que cada widget declara, y este no declaraba nada.
     *
     * Va la de listados y no la de componentes porque el CSS de
     * `.hml-agents-available` vive en la primera; la segunda entra sola, es de
     * quien depende.
     *
     * @return string[]
     */
