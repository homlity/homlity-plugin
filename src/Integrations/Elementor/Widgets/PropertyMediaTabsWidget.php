...
class PropertyMediaTabsWidget extends BasePropertyWidget
{
    ...
    {
        return __('Tabs multimedia inmueble', 'homlity-plugin');
    }
    ...
    protected function register_controls(): void
    {
        ...
        $this->add_control('initial_tab', [
            'label' => __('Pestaña inicial', 'homlity-plugin'),
            'type' => Controls_Manager::SELECT,
            'default' => 'photos',
            'options' => [
                'photos' => __('Fotos', 'homlity-plugin'),
                'videos' => __('Video', 'homlity-plugin'),
                'photos360' => __('Fotos 360°', 'homlity-plugin'),
                'tours360' => __('Recorrido 360°', 'homlity-plugin'),
            ],
            'description' => __('Si la pestaña elegida no tiene contenido, se mostrará la primera disponible.', 'homlity-plugin'),
        ]);
        $this->add_control('photos_view_mode', [
            'label' => __('Modo fotos', 'homlity-plugin'),
            'type' => Controls_Manager::SELECT,
            'default' => 'swiper_lightbox',
            'options' => [
                'swiper_lightbox' => __('Slider Swiper + Lightbox', 'homlity-plugin'),
                'swiper' => __('Solo slider Swiper', 'homlity-plugin'),
                'lightbox' => __('Mosaico con Lightbox', 'homlity-plugin'),
            ],
        ]);
        $this->add_control('slides_desktop', [
            'label' => __('Imágenes por vista (escritorio)', 'homlity-plugin'),
        ...
        $this->add_control('slides_tablet', [
            'label' => __('Imágenes por vista (tablet)', 'homlity-plugin'),
            'type' => Controls_Manager::NUMBER,
            'min' => 1, 'max' => 4, 'step' => 1,
            'default' => 1,
            'condition' => ['photos_view_mode!' => 'lightbox'],
        ...
        $this->add_control('slides_mobile', [
            'label' => __('Imágenes por vista (móvil)', 'homlity-plugin'),
            'type' => Controls_Manager::NUMBER,
            'min' => 1, 'max' => 2, 'step' => 1,
            'default' => 1,
            'condition' => ['photos_view_mode!' => 'lightbox'],
        ...
        $this->start_controls_section('style_tabs', [
            'label' => __('Estilos pestañas', 'homlity-plugin'),
        ...
        $this->add_responsive_control('tabs_radius', [
            'label' => __('Radio botones', 'homlity-plugin'),
        ...
        $this->add_responsive_control('tabs_padding', [
            'label' => __('Padding botones', 'homlity-plugin'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
        ...
        $this->start_controls_section('style_images', [
            'label' => __('Estilos imágenes', 'homlity-plugin'),
            'tab' => Controls_Manager::TAB_STYLE,
        ]);
        $this->add_responsive_control('images_height', [
            'label' => __('Alto imágenes', 'homlity-plugin'),
            ...
            'selectors' => [
                '{{WRAPPER}} .property-gallery-tabs__panel img' => 'height: {{SIZE}}{{UNIT}}; object-fit: cover;',
            ],
        ]);
        $this->add_group_control(Group_Control_Border::get_type(), [
            'name' => 'images_border',
        ...
        $this->add_responsive_control('images_radius', [
            'label' => __('Radio imágenes', 'homlity-plugin'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors' => [
        ...
        $this->start_controls_section('style_arrows', [
            'label' => __('Estilos flechas', 'homlity-plugin'),
            'tab' => Controls_Manager::TAB_STYLE,
        ]);
        $this->add_control('arrows_color', [
            'label' => __('Color flecha', 'homlity-plugin'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control('thumbs_opacity', [
            'label' => __('Opacidad inactiva', 'homlity-plugin'),
            'type' => Controls_Manager::SLIDER,
        ...
        $this->add_control('thumbs_active_opacity', [
            'label' => __('Opacidad activa', 'homlity-plugin'),
            'type' => Controls_Manager::SLIDER,
            'range' => ['px' => ['min' => 0.1, 'max' => 1, 'step' => 0.05]],
            'selectors' => [
        ...
        $this->start_controls_section('style_video', [
            'label' => __('Estilos video/360', 'homlity-plugin'),
            'tab' => Controls_Manager::TAB_STYLE,
        ]);
        $this->add_responsive_control('iframe_height', [
            'label' => __('Alto iframe', 'homlity-plugin'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['px', 'vh'],
            'range' => [
                'px' => ['min' => 180, 'max' => 900],
        ...
        $this->add_responsive_control('iframe_radius', [
            'label' => __('Radio iframe', 'homlity-plugin'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors' => [
