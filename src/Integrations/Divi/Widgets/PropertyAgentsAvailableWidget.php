    ...
    protected function render(): void
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($showPhone && $phone !== '') {
                ...
                if (!empty($phoneIcon['value']) && class_exists('\Homlity\PluginInmobiliario\Integrations\Divi\Compatibility\Icons_Manager')) {
            ...
            if ($showEmail && $email !== '') {
                ...
                if (!empty($emailIcon['value']) && class_exists('\Homlity\PluginInmobiliario\Integrations\Divi\Compatibility\Icons_Manager')) {
