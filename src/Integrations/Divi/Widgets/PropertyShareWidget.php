...
class PropertyShareWidget extends BasePropertyWidget
{
    ...
    {
        if (class_exists('\Homlity\PluginInmobiliario\Integrations\Divi\Compatibility\Icons_Manager')) {
            \Homlity\PluginInmobiliario\Integrations\Divi\Compatibility\Icons_Manager::enqueue_shim();
        }
