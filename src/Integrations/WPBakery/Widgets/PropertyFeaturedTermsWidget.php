    ...
    protected function render(): void
    {
        ...
        foreach ($groups as $group) {
            ...
            foreach ($terms as $item) {
                ...
                if (!empty($icon['value']) && class_exists('\Homlity\PluginInmobiliario\Integrations\WPBakery\Compatibility\Icons_Manager')) {
                    echo '<span class="hml-featured-terms__icon" aria-hidden="true">';
                    \Homlity\PluginInmobiliario\Integrations\WPBakery\Compatibility\Icons_Manager::render_icon($icon, ['aria-hidden' => 'true']);
                    echo '</span>';
                }
