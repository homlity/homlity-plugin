...
use Homlity\PluginInmobiliario\Integrations\WPBakery\Compatibility\Icons_Manager;
    ...
    protected function render(): void
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($showPhone && $phone !== '') {
                ...
                if (!empty($phoneIcon['value']) && class_exists('\Homlity\PluginInmobiliario\Integrations\WPBakery\Compatibility\Icons_Manager')) {
            ...
            if ($showEmail && $email !== '') {
                ...
                if (!empty($emailIcon['value']) && class_exists('\Homlity\PluginInmobiliario\Integrations\WPBakery\Compatibility\Icons_Manager')) {
