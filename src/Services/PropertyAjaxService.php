...
class PropertyAjaxService implements ServiceInterface
{
    ...
    public function handle(): void
    {
        ...
        $filterParams = [
            ...
            'locality'         => sanitize_text_field(wp_unslash($_POST['locality']     ?? '')),
